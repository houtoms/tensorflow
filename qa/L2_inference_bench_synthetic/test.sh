...
do
  ...
  do
    ...
    common_args="--model $i --batch_size $bs --use_synthetic --num_iterations 2000"
    ...
    python -u inference.py $common_args --use_trt --precision int8 --num_calib_inputs $bs 2>&1 | tee $OUTPUT_PATH/output_tftrt_${bs}_int8_$i
