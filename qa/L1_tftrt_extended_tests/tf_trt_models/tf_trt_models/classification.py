...
NETS = {
    ...
    NetDef(_mobilenet_v1_0p25_128,
           ...
           inception_preprocessing.preprocess_image, tf.nn.softmax,
    ...
    NetDef(_mobilenet_v1_0p5_160, nets.mobilenet_v1.mobilenet_v1_arg_scope,
           160, 160, inception_preprocessing.preprocess_image, tf.nn.softmax,
    ...
    NetDef(_mobilenet_v1_1p0_224, nets.mobilenet_v1.mobilenet_v1_arg_scope,
           224, 224, inception_preprocessing.preprocess_image, tf.nn.softmax,
    ...
    NetDef(nets.vgg.vgg_16, nets.vgg.vgg_arg_scope, 224, 224,
           vgg_preprocessing.preprocess_image, tf.nn.softmax,
    ...
    NetDef(nets.inception.inception_v3, nets.inception.inception_v3_arg_scope,
           299, 299, inception_preprocessing.preprocess_image, tf.nn.softmax,
    ...
    NetDef(models.official.resnet.imagenet_main.ImagenetModel(resnet_size=50, resnet_version=1, num_classes=1001, data_format='channels_last'), None,
           224, 224, vgg_preprocessing.preprocess_image, tf.nn.softmax,
    ...
    NetDef(nets.nasnet.nasnet.build_nasnet_large, nets.nasnet.nasnet.nasnet_large_arg_scope,
           331, 331, inception_preprocessing.preprocess_image, tf.nn.softmax,
        ...
        with tf.Session(config=tf_config) as tf_sess:
            ...
            if net.slim:
                ...
                with slim.arg_scope(net.arg_scope()):
                    tf_net, tf_end_points = net.model(tf_input, is_training=False,
                        num_classes=num_classes)
            else:
                # TF Official Model
                tf_net = net.model(tf_input, training=False)
