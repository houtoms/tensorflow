...
command = "{{}} main.py --mode={mode}_benchmark --batch_size={batch_size} --warmup_steps={bench_warmup} --num_iter={num_iter} --precision={precision} --iter_unit=batch --data_dir={data_dir} --results_dir={results_dir}/{exp_name}"
