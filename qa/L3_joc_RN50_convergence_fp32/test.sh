...
python /opt/tensorflow/qa/joc_qa/testscript.py --precision fp32 --iterations 90 --ngpus 8 --bs 128 --top1-baseline 76 --top5-baseline 92 --data_dir imagenet-tfrecord --results_dir /tmp/results
