...
do
  echo "Testing $i..."
  python -u inference.py --batch_size 64 --model $i --use_trt --precision int8 --download_dir /mnt/shared/dldata/tensorflow/models 2>&1 | tee $OUTPUT_PATH/output_tftrt_int8_$i
