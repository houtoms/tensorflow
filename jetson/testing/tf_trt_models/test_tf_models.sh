...
python tf_trt_inference_test.py --model resnet_v2_101 --num_classes 1001 --use_trt 0 
rm -r data

python tf_trt_inference_test.py --model resnet_v2_152 --num_classes 1001 --use_trt 0 
rm -r data
...
python tf_inference_test.py --model mobilenet_v1_0.25_128 --num_classes 1001 --use_trt 0
rm -r data
