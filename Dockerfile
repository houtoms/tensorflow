...
ENV NVIDIA_TENSORFLOW_VERSION 18.06
...
# TensorRT
RUN wget -qO libnvinfer.deb "http://cuda-repo/release-candidates/Libraries/TensorRT/v4.0/4.0.1.3-GA-cl-24261820/CUDA9.0-r384/Ubuntu16_04-x64/deb/libnvinfer4_4.1.2-1+cuda9.0_amd64.deb" && \
    wget -qO libnvinfer-dev.deb "http://cuda-repo/release-candidates/Libraries/TensorRT/v4.0/4.0.1.3-GA-cl-24261820/CUDA9.0-r384/Ubuntu16_04-x64/deb/libnvinfer-dev_4.1.2-1+cuda9.0_amd64.deb" && \
