...
if __name__ == "__main__":
    ...
    parser.add_argument('--tolerance', dest='tolerance', default=0.1)
    parser.add_argument('--batch_size', dest='batch_size', default=8)
    parser.add_argument('--precision', dest='precision', default='tf_fp32')
    parser.add_argument('--input_path', dest='input_path')

    args = parser.parse_args()

    fn = 'output_' + args.precision + "_bs" + str(args.batch_size) + "_" + args.model
